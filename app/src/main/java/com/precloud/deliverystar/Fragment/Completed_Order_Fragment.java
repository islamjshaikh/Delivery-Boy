...
import com.precloud.deliverystar.Adapter.CompletedOrderAdapter;
...
public class Completed_Order_Fragment extends Fragment {

   List<OrderResponse> orderResponseList = new ArrayList<>();
    public static  RecyclerView recy_completed_order;
    CompletedOrderAdapter orderAdapter;
...
TextView txt_no_orders;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_completed__order_,container,false);
                        ...
                        if (response.body().getStatus().equals("1")){
                            if(response.body().getResult()!=null){
                                ...
                                if (orderResponseList.size()>0 && orderResponseList!=null){
                                   ...
                                   orderAdapter = new CompletedOrderAdapter(getActivity(),orderResponseList);
                                    recy_completed_order.setLayoutManager(new LinearLayoutManager(getActivity()));
                                    recy_completed_order.setAdapter(orderAdapter);

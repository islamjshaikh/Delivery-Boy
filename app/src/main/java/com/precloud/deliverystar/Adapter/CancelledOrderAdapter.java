...
import com.precloud.deliverystar.Activity.CancelledOrderDetailActivity;
...
public class CancelledOrderAdapter extends RecyclerView.Adapter<CancelledOrderAdapter.ViewHolder> {
    ...
    public CancelledOrderAdapter(Context context, List<OrderResponse> arrayList) {
    ...
    @NonNull
    @Override
    public CancelledOrderAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_completed_orders,viewGroup,false);
        return new CancelledOrderAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull CancelledOrderAdapter.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView txt_orderid,txt_hotel_name,txt_sourceaddress,txt_dest_address,txt_price,txt_paymentmod,txt_receiptname,pick_up_time;
